...
from ..controle.controleUsuario import autenticar_usuario, validar_segundo_fator
...
def autenticar():
    print("Endpoint /autenticar chamado")
    data = request.json
    ...
    if 'verification_code' in data:
        verificacao = validar_segundo_fator(data.get('verification_code'))
